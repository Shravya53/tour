...
<script type="text/javascript">
	function validation(){
		...
		cnpas = document.getElementById("cnpas").value;
		mobile = document.getElementById("mobile").value;
		
		if(name!=null&&email!=null&&mobile!=null&&pass!=null&&cnpas!=null&&name!=""&&email!=""&&mobile!=""&&pass!=""&&cnpas!=""&&name.length>0&&email.length>0&&mobile.length==10&&pass.length>0&&pass==cnpas){
			return true;
		}else {
						...
						<div class="row">
							<div class="col-lg-12">
								<form action="../Register" method="post" onsubmit="return validation()" id="login-form" role="form" style="display: block;">
									...
									<div class="form-group">
										<input type="password" name="cnpas" id="cnpas" tabindex="4" class="form-control" placeholder="Confirm password" >
									</div>
									<div class="form-group">
										<input type="number" name="mobile" id="mobile" tabindex="5" class="form-control" placeholder="Mobile" >
									</div>
									<div class="form-group">
										<input type="text" name="nickname" id="nickname" tabindex="6" class="form-control" placeholder="Enter your nickname" >
									</div>
									<div class="form-group">
										<div class="row">
